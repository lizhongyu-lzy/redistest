...
public class UserHashJSON {

	@Resource
	private RedisTemplate<String, Serializable> redis;
	/** 
	 * @Title: jdk_test 
	 * @Description: 4.	使用json系列化方式保存十万个user随机对象到Redis，并计算耗时
	 * @return: void
	 */
	@Test
	public void jdk_hash_Json() {
		...
		System.out.println("系列化方式 :json储存类型Hash保存数量:"+users.size()+"所耗时间:"+(stop-start));
